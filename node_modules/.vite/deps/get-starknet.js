...
function create_each_block_1(t) {
  ...
  return {
    ...
    d(m) {
      m && detach(e), l.d(), i = false, run_all(s);
    }
  };
}
...
function create_fragment(t) {
  ...
  return {
    ...
    o: noop,
    d(g) {
      g && detach(e), destroy_each(h, g), destroy_each(w, g), d = false, run_all(m);
    }
  };
}
...
function instance(t, e, r) {
  ...
  } } = e, { theme: l = null } = e, u = false, d = async (b) => {
    var _;
    r(1, u = (_ = b == null ? void 0 : b.id) != null ? _ : false), await c(b).catch(() => {
    }), r(1, u = false);
  }, m = "";
...
var Utils = class _Utils {
  ...
  static compareVersions(e, r, n = false) {
    const o = _Utils.getVersionPrecision(e), i = _Utils.getVersionPrecision(r);
    let s = Math.max(o, i), a = 0;
    const c = _Utils.map([e, r], (l) => {
      const u = s - _Utils.getVersionPrecision(l), d = l + new Array(u + 1).join(".0");
      return _Utils.map(d.split("."), (m) => new Array(20 - m.length).join("0") + m).reverse();
    });
...
var X = (t, e, r) => e in t ? Z(t, e, { enumerable: true, configurable: true, writable: true, value: r }) : t[e] = r;
...
var $ = (t, e, r, n) => (B(t, e, "write to private field"), n ? n.call(t, r) : e.set(t, r), r);
var P = (t, e, r) => (B(t, e, "access private method"), r);
...
var LocalStorageWrapper = class {
  constructor(e) {
    L(this, H), L(this, C), L(this, T, false), L(this, j, void 0), L(this, x, void 0), F(this, "value"), $(this, x, e), P(this, C, G).call(this);
  }
  set(e) {
    return !N(this, T) && !P(this, C, G).call(this) ? false : (this.delete(), this.value = e, e && ($(this, j, `${N(this, x)}-${generateUID()}`), localStorage.setItem(N(this, j), e)), true);
  }
  get() {
    return P(this, H, Q).call(this), this.value;
  }
  delete() {
    return !N(this, T) && !P(this, C, G).call(this) ? false : (this.value = null, N(this, j) && localStorage.removeItem(N(this, j)), true);
  }
};
T = /* @__PURE__ */ new WeakMap(), j = /* @__PURE__ */ new WeakMap(), x = /* @__PURE__ */ new WeakMap(), H = /* @__PURE__ */ new WeakSet(), Q = function() {
  ...
  try {
    ...
    )), $(this, T, true), N(this, j) && this.set(localStorage.getItem(N(this, j))));
  } catch (t) {
    console.warn(t);
  }
  return N(this, T);
...
var filterByPreAuthorized = async (t) => {
...
function findSingletonVersionOrderByLoaded(t, e, r) {
  const n = t[e][r];
  return findVersion(t, e, r, function(o, i) {
    return isLoaded(n[i]) ? isLoaded(n[o]) ? Boolean(versionLt(o, i)) : true : isLoaded(n[o]) ? false : versionLt(o, i);
  });
}
...
function createScript(t, e, r, n) {
  for (var o = null, i = true, s = document.getElementsByTagName("script"), a = 0; a < s.length; a++) {
...
function createLink(t, e) {
  for (var r = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {}, n = arguments.length > 3 ? arguments[3] : void 0, o = null, i = true, s = document.getElementsByTagName("link"), a = 0; a < s.length; a++) {
...
function _iterable_to_array_limit(t, e) {
  ...
  if (r != null) {
    var n = [], o = true, i = false, s, a;
    try {
      for (r = r.call(t); !(o = (s = r.next()).done) && (n.push(s.value), !(e && n.length === e)); o = true)
        ;
    } catch (c) {
      i = true, a = c;
    } finally {
...
var AsyncHook = class extends SyncHook {
  emit(...e) {
    ...
    if (n.length > 0) {
      let o = 0;
      const i = (s) => s === false ? false : o < n.length ? Promise.resolve(n[o++].apply(null, e)).then(i) : s;
      r = i();
    }
...
function generatePreloadAssets(t, e, r, n, o) {
  ...
  }, true, {}, o), o.shared && o.shared.forEach((h) => {
    var y;
  ...
  loadShareSync(e, r) {
    ...
    if (i) {
      if (typeof i.lib == "function")
        return s(i), i.loaded || (i.loaded = true, i.from === this.options.name && (o.loaded = true)), i.lib;
...
function detectMetaMaskProvider(t, { timeout: e = 3e3 } = {}) {
  ...
  return new Promise((n) => {
    const o = (i) => {
      ...
      ["io.metamask", "io.metamask.flask"].includes(s.rdns) && isMetaMaskProvider(a) && (n(a), r = true);
    };
...
function createMetaMaskProviderWrapper(t, e) {
  ...
  return {
    ...
    get isConnected() {
      var o;
      return (o = r == null ? void 0 : r.isConnected) != null ? o : false;
    },
    get provider() {
    ...
    isPreauthorized() {
      var o;
      return (o = r == null ? void 0 : r.isPreauthorized()) != null ? o : Promise.resolve(false);
    },
    on(o, i) {
      if (!r)
        throw new Error("Wallet not enabled");
...
var enableWithVersion = async (t) => t ? main.enable(t, { starknetVersion: "v5" }).catch(() => null) : null;
var connect = async ({
  modalMode: t = "canAsk",
