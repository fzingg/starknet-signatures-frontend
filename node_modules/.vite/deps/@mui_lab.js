...
var maybeReactUseId = React21["useId".toString()];
...
function getReactNodeRef(element) {
  if (!element || !React28.isValidElement(element)) {
    return null;
  }
...
function ClickAwayListener(props) {
  ...
  return (0, import_jsx_runtime8.jsx)(React32.Fragment, {
...
function useControllableReducer(parameters) {
  ...
  const controlledPropsRef = React34.useRef(controlledProps);
  if (true) {
    React34.useEffect(() => {
      Object.keys(controlledProps).forEach((key) => {
...
function FocusTrap(props) {
  ...
  return (0, import_jsx_runtime10.jsxs)(React37.Fragment, {
...
function useList(params) {
  ...
  const actionContext = React44.useMemo(() => ({
...
function useListItem(parameters) {
  ...
  const createHandleClick = React46.useCallback((externalHandlers) => (event) => {
    var _a;
  ...
  const createHandlePointerOver = React46.useCallback((externalHandlers) => (event) => {
    var _a;
...
function useCompoundItem(id, itemMetadata) {
  const context = React48.useContext(CompoundComponentContext);
  if (context === null) {
  ...
  const [registeredId, setRegisteredId] = React48.useState(typeof id === "function" ? void 0 : id);
  useEnhancedEffect_default2(() => {
    const {
      id: returnedId,
      deregister
...
function useMenu(parameters = {}) {
  ...
  const {
    ...
    triggerElement,
    registerPopup
  } = React49.useContext(DropdownContext) ?? FALLBACK_MENU_CONTEXT;
...
var Portal = React52.forwardRef(function Portal2(props, forwardedRef) {
  ...
  if (disablePortal) {
    ...
    return (0, import_jsx_runtime14.jsx)(React52.Fragment, {
      children
    });
  }
  return (0, import_jsx_runtime14.jsx)(React52.Fragment, {
...
function useMenuItem(params) {
  ...
  const {
    dispatch
  } = React61.useContext(DropdownContext) ?? FALLBACK_MENU_CONTEXT2;
  const {
    getRootProps: getListRootProps,
    highlighted
  } = useListItem({
...
var Option2 = React72.forwardRef(function Option3(props, ref) {
  ...
  return (0, import_jsx_runtime23.jsx)(ListContext.Provider, {
    value: contextValue,
    children: (0, import_jsx_runtime23.jsx)(InnerOption, {
      ...props,
      ref
    })
  });
...
function defaultRenderValue(selectedOptions) {
  if (Array.isArray(selectedOptions)) {
    return (0, import_jsx_runtime26.jsx)(React76.Fragment, {
...
var Select = React76.forwardRef(function Select2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime26.jsxs)(React76.Fragment, {
...
var Slider = React78.forwardRef(function Slider2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime27.jsxs)(Root, {
    ...
    children: [(0, import_jsx_runtime27.jsx)(Rail, {
      ...
      return (0, import_jsx_runtime27.jsxs)(React78.Fragment, {
...
function useTabs(parameters) {
  ...
  const getTabId2 = React85.useCallback((tabPanelId) => {
...
var TextareaAutosize = React96.forwardRef(function TextareaAutosize2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime38.jsxs)(React96.Fragment, {
...
function useAutocomplete(props) {
  ...
  const ignoreFocus = React99.useRef(false);
  const firstFocus = React99.useRef(true);
  const inputRef = React99.useRef(null);
  const listboxRef = React99.useRef(null);
  const [anchorEl, setAnchorEl] = React99.useState(null);
  const [focusedTag, setFocusedTag] = React99.useState(-1);
  const defaultHighlighted = autoHighlight ? 0 : -1;
  const highlightedIndexRef = React99.useRef(defaultHighlighted);
  ...
  const resetInputValue = React99.useCallback((event, newValue, reason) => {
  ...
  const [inputPristine, setInputPristine] = React99.useState(true);
  ...
  const syncHighlightedIndex = React99.useCallback(() => {
    if (!popupOpen) {
      return;
    }
  ...
  const isTouch = React99.useRef(false);
...
var LoadingButton = React100.forwardRef(function LoadingButton2(inProps, ref) {
  const contextProps = React100.useContext(ButtonGroupContext_default);
...
var LocalizationProvider = React101.forwardRef(function DeprecatedLocalizationProvider() {
  warn15();
  return null;
});
...
var MobileDatePicker = React102.forwardRef(function DeprecatedMobileDatePicker(props, ref) {
  warn16();
  return null;
});
...
var MobileDateRangePicker = React103.forwardRef(function DeprecatedMobileDateRangePicker() {
  warn17();
  return null;
});
...
var MobileDateTimePicker = React104.forwardRef(function DeprecatedMobileDateTimePicker() {
  warn18();
  return null;
});
...
var MobileTimePicker = React105.forwardRef(function DeprecatedMobileTimePicker() {
  warn19();
  return null;
});
...
var MonthPicker = React106.forwardRef(function DeprecatedMonthPicker() {
  warn20();
  return null;
});
...
var Pagination_default2 = React107.forwardRef(function DeprecatedPagination(props, ref) {
  warn21();
...
var PaginationItem_default2 = React108.forwardRef(function DeprecatedPaginationItem(props, ref) {
  warn22();
...
var CalendarPickerSkeleton = React109.forwardRef(function DeprecatedCalendarPickerSkeleton() {
  warn23();
  return null;
});
...
var PickersDay = React110.forwardRef(function DeprecatedPickersDay() {
  warn24();
  return null;
});
...
var Rating_default2 = React111.forwardRef(function DeprecatedRating(props, ref) {
  warn25();
...
var Skeleton_default2 = React112.forwardRef(function DeprecatedSkeleton(props, ref) {
  warn26();
...
var SpeedDial_default2 = React113.forwardRef(function DeprecatedSpeedDial(props, ref) {
  warn27();
...
var SpeedDialAction_default2 = React114.forwardRef(function DeprecatedSpeedDialAction(props, ref) {
  warn28();
...
var SpeedDialIcon_default2 = React115.forwardRef(function DeprecatedSpeedDialIcon(props, ref) {
  warn29();
...
var StaticDatePicker = React116.forwardRef(function DeprecatedStaticDatePicker() {
  warn30();
  return null;
});
...
var StaticDateRangePicker = React117.forwardRef(function DeprecatedStaticDateRangePicker() {
  warn31();
  return null;
});
...
var StaticDateTimePicker = React118.forwardRef(function DeprecatedStaticDateTimePicker() {
  warn32();
  return null;
});
...
var StaticTimePicker = React119.forwardRef(function DeprecatedStaticTimePicker() {
  warn33();
  return null;
});
...
var Context = React120.createContext(null);
if (true) {
  Context.displayName = "TabContext";
}
function useUniquePrefix() {
  const [id, setId] = React120.useState(null);
  React120.useEffect(() => {
...
function useTabContext() {
  return React120.useContext(Context);
}
...
var TabList = React121.forwardRef(function TabList2(props, ref) {
  const {
...
var TabPanel3 = React122.forwardRef(function TabPanel4(inProps, ref) {
...
var TimePicker = React123.forwardRef(function DeprecatedTimePicker() {
  warn34();
  return null;
});
...
var TimelineContext = React124.createContext({});
if (true) {
...
var Timeline = React125.forwardRef(function Timeline2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTimeline"
  });
...
var TimelineConnector = React126.forwardRef(function TimelineConnector2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTimelineConnector"
  });
...
var TimelineContent = React127.forwardRef(function TimelineContent2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTimelineContent"
  });
  ...
  } = React127.useContext(TimelineContext_default);
  const ownerState = {
    ...props,
...
var TimelineDot = React128.forwardRef(function TimelineDot2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTimelineDot"
  });
...
var TimelineOppositeContent = React129.forwardRef(function TimelineOppositeContent2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTimelineOppositeContent"
  });
...
var TimelineItem = React130.forwardRef(function TimelineItem2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTimelineItem"
  });
  ...
  React130.Children.forEach(props.children, (child) => {
...
var TimelineSeparator = React131.forwardRef(function TimelineSeparator2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTimelineSeparator"
  });
...
var ToggleButton_default2 = React132.forwardRef(function DeprecatedToggleButton(props, ref) {
  warn35();
...
var ToggleButtonGroup_default2 = React133.forwardRef(function DeprecatedToggleButtonGroup(props, ref) {
  warn36();
...
var TreeItem = React134.forwardRef(function DeprecatedTreeItem() {
  warn37();
  return null;
});
...
var TreeView = React135.forwardRef(function DeprecatedTreeView() {
  warn38();
  return null;
});
...
var Masonry = React136.forwardRef(function Masonry2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiMasonry"
  });
  ...
  const masonryRef = React136.useRef();
  const [maxColumnHeight, setMaxColumnHeight] = React136.useState();
  const isSSR = !maxColumnHeight && defaultHeight && defaultColumns !== void 0 && defaultSpacing !== void 0;
  const [numberOfLineBreaks, setNumberOfLineBreaks] = React136.useState(isSSR ? defaultColumns - 1 : 0);
  const ownerState = {
    ...props,
    spacing,
    columns,
  ...
  const handleResize = React136.useCallback((masonryChildren) => {
